...
'rotasi 1
'Variabel global ini menyimpan sudut rotasi dan posisi mouse terakhir
'agar rotasi bisa dihitung saat mouse digerakkan.
...
Public Sub InitGL(picHDC As Long, width As Long, height As Long)
    ...
    'Baris ini mengatur warna latar belakang menjadi coklat seperti papan catur.
    'Nilai RGB (0.55, 0.39, 0.24) menentukan warna, dan angka 1 menunjukkan tingkat transparansi penuh.
...
Public Sub InitLighting()
    ...
    'bentuk 4
    'InitLighting menyalakan lampu (GL_LIGHT0) dan mengatur posisi serta warna cahaya.
    'matColor memberi warna krem pada pion.
    'Kombinasi ini menciptakan efek 3D realistis dengan gradasi cahaya lembut.
...
Public Sub DrawPawn()
    ...
    stepAngle = 5!
    'bentuk 1
    'Array r() menyimpan jari-jari dan Y() menyimpan tinggi dari pion.
    'Data ini menjadi profil 2D pion yang nantinya diputar 360° untuk menampilkan tubuh 3D.
    Dim r(20) As Single
    Dim Y(20) As Single
    ...
    'bentuk 2
    'Perulangan ini memutar profil 2D mengelilingi sumbu Y untuk membentuk permukaan 3D.
    'GL_QUAD_STRIP menyambungkan dua cincin titik menjadi dinding pion.
    'glNormal3f memberi arah cahaya agar pencahayaan tampak halus.
    ...
    'bentuk 3
    'Bagian kepala pion dibuat dengan gluSphere, yaitu bola dengan jari-jari 0.55.
    'Posisinya diatur sedikit di atas leher (Y(15) + 0.45)
...
Public Sub DrawScene(picHDC As Long)
    ...
    'Setiap kali gambar diperbarui, perintah ini menghapus layar dan mengisi ulang dengan warna
    'yang sudah diset oleh glClearColor.
    ...
    'rotasi 4
    'rotY memutar posisi kamera mengelilingi pion,
    'sedangkan rotX memutar pion ke atas atau ke bawah.
    'Kombinasi ini menghasilkan rotasi penuh yang halus.
    ...
    'rotasi 5
    'SwapBuffers mengganti buffer belakang ke depan,
    'membuat animasi dan rotasi tampak halus tanpa flicker.
